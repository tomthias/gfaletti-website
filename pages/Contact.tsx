    ...
    <div className="max-w-7xl mx-auto px-6 py-20 min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div className="grid md:grid-cols-2 gap-10 w-full max-w-4xl">
        <div className="bg-white/5 border border-white/10 p-12 text-center hover:bg-white/10 transition-colors">
          ...
          <a href="mailto:g.faletti@gmail.com" className="text-2xl font-serif hover:text-accent transition-colors underline decoration-accent/30 underline-offset-8">
            g.faletti@gmail.com
          </a>
        </div>
        
        <div className="bg-white/5 border border-white/10 p-12 text-center hover:bg-white/10 transition-colors">
          <h3 className="text-[10px] uppercase tracking-widest text-accent font-bold mb-4">Follow Alpinism</h3>
          <a href="https://instagram.com/giordanofaletti" target="_blank" rel="noopener noreferrer" className="text-2xl font-serif hover:text-accent transition-colors underline decoration-accent/30 underline-offset-8">
            @giordanofaletti
          </a>
        </div>
      </div>

      <div className="mt-20 text-[10px] uppercase tracking-[4px] text-white/20">
        Based in Trentino, IT • Available Worldwide
      </div>
    </div>
  );
};
